...
\title{Flipped teaching as a method for boosting engagement and performance (unfinished draft, moved to Word document)}
\author{Dr Sam Marsh}
...
\bibitem[LH]{lh} B. Lin and C. Hsieh, \emph{Web-based teaching and learner control: A research
review.} Computers and Education, 37(3-4), 2001, 377-386.

\bibitem[MM]{mm }M. Mavrikis and A. Maciocia, \emph{ Incorporating assessment into an interactive
